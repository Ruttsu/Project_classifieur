...
public:
    ...
    virtual std::vector<std::pair<float, size_t>> predictSingle(const FeatureVector& test, int k) const override; // I : Feature and int | O : Vector of <double, unsigned int>
